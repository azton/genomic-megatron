...
class Partition(object):
    ...
    def process_json_file(self, file_name):
        ...
        fin.close()
        print('Done parsing, calling finalize...')
...
def get_args():
    ...
    group.add_argument('--sliding-window', action='store_true',
                       help="use sliding window on genomic data")
    group.add_argument('--single-sample', action='store_true',
                       help="pad sequences to the same length (1024)")
    group.add_argument('--bpe-genome', action='store_true',
                          help="use BPE vocab on GenomeTokenizer")
...
def main():
    ...
    processes = []
    print('Sending to multiprocess [347]')
    ...
    print("Done with parallel, calling merge...")
